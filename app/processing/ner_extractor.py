...
class NERExtractor:
    ...
    def __init__(
        ...
        self._bern2_disabled: bool = False
        self._bern2_fail_count: int = 0
    ...
    def extract(self, text: str) -> list[dict[str, Any]]:
        ...
        if enable_bern2 and not self._bern2_disabled:
            try:
                res = self._extract_bern2(text)
                self._bern2_fail_count = 0
                return res
